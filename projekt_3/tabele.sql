...
(
    ...
    CONSTRAINT fk_modsil_mod FOREIGN KEY (model_id) REFERENCES Modele(id),
    CONSTRAINT fk_modsil_sil FOREIGN KEY (silnik_id) REFERENCES Typy_silnika(id),
);
...
(
    ...
    CONSTRAINT  fk_dod_samoch FOREIGN KEY (samochod) REFERENCES Samochody(VIN)
);
...
(
    dealer     VARCHAR(20),
    model      INT,
    CONSTRAINT fk_spec_deal FOREIGN KEY (dealer) REFERENCES Dealerzy(nazwa),
    CONSTRAINT fk_spec_mod  FOREIGN KEY (model) REFERENCES Modele(id)
);
